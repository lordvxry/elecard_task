...
import {baseClosedCardIds, basePageNumber, baseSortValue} from "../../global/constants";
...
const ClassicCatalog = ({catalog}) => {
    ...
    const currentCatalog = catalogFilter.slice(firstCatalogIndex, lastCatalogIndex);
